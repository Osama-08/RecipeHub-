                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        placeholder="0.00"
                                        className="w-full pl-8 pr-4 py-2 border-2 border-gray-200 rounded-lg focus:border-orange-500 focus:outline-none"
                                    />
                                </div>
                                <p className="text-xs text-gray-500 mt-1">Enter 0 for free documents</p>
                            </div>
